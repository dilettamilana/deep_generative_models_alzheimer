...
class Visualiser():
    ...
    def ScatterOfLatentSpace(self, dataset_images, dataset_encoded_images, dataset_labels, tsne_perplexity, display=True, n_components=2):
        ...
        tsne = manifold.TSNE(n_components=n_components, perplexity=tsne_perplexity, init='pca', random_state=0)
    ...
    def computeTSNEProjectionOfLatentSpace(self, dataset_images, dataset_encoded_images, dataset_labels, tsne_perplexity, n_components, _3d, max_images=50, display=True):
        ...
        # Compute t-SNE embedding of latent space
        print("Computing t-SNE embedding...")
        tsne = manifold.TSNE(perplexity=tsne_perplexity, n_components=n_components, init='pca', random_state=0)
        X_tsne = tsne.fit_transform(X_encoded)
    ...
    def computeTSNEProjectionOfPixelSpace(self, dataset_images, dataset_labels, tsne_perplexity, n_components, _3d=False, display=True):
        assert (_3d and n_components==3) or ((not _3d) and n_components==2), "check your settings: _3d has to be False if n_components=2 or True if n_components=3."
