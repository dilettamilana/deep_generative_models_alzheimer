...
images_dict={ImagePath(_dataset="HARP", _3d=False, _info="segmented"): "Harp\\images_hippo_volumes.npy",
             ...
             ImagePath(_dataset="HARP", _3d=True, _info="orig_64centerslices"): "Harp\\orig_64centerslices.npy",
             ImagePath(_dataset="HARP", _3d=True, _info="orig_32centerslices"): "Harp\\orig_32centerslices.npy",
             ImagePath(_dataset="HARP", _3d=True, _info="orig_4centerslices"): "Harp\\orig_4centerslices.npy",
             ImagePath(_dataset="HARP", _3d=False, _info="orig_64centerslices_flattened"): "Harp\\orig_64centerslices_flattened.npy",
             ImagePath(_dataset="HARP", _3d=False, _info="orig_32centerslices_flattened"): "Harp\\orig_32centerslices_flattened.npy",
             ImagePath(_dataset="HARP", _3d=False, _info="orig_4centerslices_flattened"): "Harp\\orig_4centerslices_flattened.npy",
             ...
             ImagePath(_dataset="AIBL", _3d=True, _info="orig_64centerslices"): "AIBL\\orig_64centerslices.npy",
             ImagePath(_dataset="AIBL", _3d=True, _info="orig_32centerslices"): "AIBL\\orig_32centerslices.npy",
             ImagePath(_dataset="AIBL", _3d=True, _info="orig_4centerslices"): "AIBL\\orig_4centerslices.npy",
             ImagePath(_dataset="AIBL", _3d=False, _info="orig_64centerslices_flattened"): "AIBL\\orig_64centerslices_flattened.npy",
             ImagePath(_dataset="AIBL", _3d=False, _info="orig_32centerslices_flattened"): "AIBL\\orig_32centerslices_flattened.npy",
             ImagePath(_dataset="AIBL", _3d=False, _info="orig_4centerslices_flattened"): "AIBL\\orig_4centerslices_flattened.npy",
             ...
             ImagePath(_dataset="OASIS", _3d=True, _info="orig_64centerslices"): "OASIS\\orig_64centerslices.npy",
             ImagePath(_dataset="OASIS", _3d=True, _info="orig_32centerslices"): "OASIS\\orig_32centerslices.npy",
             ImagePath(_dataset="OASIS", _3d=True, _info="orig_4centerslices"): "OASIS\\orig_4centerslices.npy",
             ImagePath(_dataset="OASIS", _3d=False, _info="orig_64centerslices_flattened"): "OASIS\\orig_64centerslices_flattened.npy",
             ImagePath(_dataset="OASIS", _3d=False, _info="orig_32centerslices_flattened"): "OASIS\\orig_32centerslices_flattened.npy",
             ImagePath(_dataset="OASIS", _3d=False, _info="orig_4centerslices_flattened"): "OASIS\\orig_4centerslices_flattened.npy",
...
labels_dict ={LabelPath(_dataset="HARP", _onehot=True, _all_fields=False): "Harp\\labels.npy",
              ...
              LabelPath(_dataset="HARP", _onehot=False, _all_fields=True,_info="orig_64centerslices_flattened"): "Harp\\labels_all_fields_orig_64centerslices_flattened.npy",
              LabelPath(_dataset="HARP", _onehot=False, _all_fields=True,_info="orig_32centerslices_flattened"): "Harp\\labels_all_fields_orig_32centerslices_flattened.npy",
              LabelPath(_dataset="HARP", _onehot=False, _all_fields=True,_info="orig_4centerslices_flattened"): "Harp\\labels_all_fields_orig_4centerslices_flattened.npy",
              ...
              LabelPath(_dataset="AIBL", _onehot=False, _all_fields=True,_info="orig_64centerslices_flattened"): "AIBL\\labels_all_fields_orig_64centerslices_flattened.npy",
              LabelPath(_dataset="AIBL", _onehot=False, _all_fields=True,_info="orig_32centerslices_flattened"): "AIBL\\labels_all_fields_orig_32centerslices_flattened.npy",
              LabelPath(_dataset="AIBL", _onehot=False, _all_fields=True,_info="orig_4centerslices_flattened"): "AIBL\\labels_all_fields_orig_4centerslices_flattened.npy",
              ...
              LabelPath(_dataset="OASIS", _onehot=False, _all_fields=True, _info="orig_64centerslices_flattened"): "OASIS\\labels_all_fields_orig_64centerslices_flattened.npy",
              LabelPath(_dataset="OASIS", _onehot=False, _all_fields=True,_info="orig_32centerslices_flattened"): "OASIS\\labels_all_fields_orig_32centerslices_flattened.npy",
              LabelPath(_dataset="OASIS", _onehot=False, _all_fields=True,_info="orig_4centerslices_flattened"): "OASIS\\labels_all_fields_orig_4centerslices_flattened.npy",
